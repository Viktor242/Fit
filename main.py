...
def handle_support(message):
    help_text = [
        ...
        "2️⃣ **Как написать в тех. поддержку** - Напиши /help.",
        "3️⃣ **Расписание** - Получите информацию о расписании приема воды,утром в 7:00.",
        "4️⃣ **Факты о здоровом образе жизни** - Интересные и полезные факты о здоровье.",
        "5️⃣ **Перекусы** - Правильное питание, залог здоровья.",
        "6️⃣ **Персональные тренировки** - Контроль физической активности."
    ]
